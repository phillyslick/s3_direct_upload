...
This branch exposes the expiration and acl options to the S3DirectUpload initializer and sets the request header to force the download of object.
## Installation
...
S3DirectUpload.config do |c|
  ...
  c.url = nil                # S3 API endpoint (optional), eg. "https://#{c.bucket}.s3.amazonaws.com/"
	c.expiration = 42.minutes.from_now # not sure if this is working
	c.acl = "authenticated-read" # This IS working.  
end
```
